...
// ─── Day Selector ──────────────────────────────────────────
Widget buildDaySelector(Set<int> selectedDays, Function(Set<int>) onChanged) {
  void toggle(int i) {
...
// ─── Duration Card ─────────────────────────────────────────
Widget buildDurationCard(int durationH, int durationM, {VoidCallback? onTap}) {
  return GestureDetector(
    onTap: onTap,
    child: Container(
        ...
        children: [
          ...
          Column(
            ...
            children: [
              ...
              const SizedBox(height: 2),
              Text(formatDurationHM(durationH, durationM),
                  style: GoogleFonts.dmSans(
                    fontSize: 16,
                    fontWeight: FontWeight.w600,
...
// ─── Repeat Info Card ──────────────────────────────────────
Widget buildRepeatInfoCard(Set<int> selectedDays) {
...
// ─── Power Toggle Row ──────────────────────────────────────
Widget buildPowerToggleRow(bool isEnabled, VoidCallback onToggle) {
  return Row(
...
Widget buildCreateScheduleButton(VoidCallback? onTap) {
  return Container(
    width: double.infinity,
    height: 48,
    decoration: BoxDecoration(
